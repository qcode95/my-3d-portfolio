...
const RESUME_PATH = "/CV_FullstackDeveloper_NguyenXuanQuy.pdf";
    ...
    <div className="flex min-h-screen flex-col font-sans">
      ...
      <div className="mx-auto w-full max-w-4xl shrink-0 px-4 pt-16 md:pt-24">
        ...
        >
          ...
          <a
            href={RESUME_PATH}
            download="CV_FullstackDeveloper_NguyenXuanQuy.pdf"
            className={cn(buttonVariants(), "flex gap-2 text-sm")}
          >
